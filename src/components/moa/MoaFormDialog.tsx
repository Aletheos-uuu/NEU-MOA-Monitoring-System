...
export function MoaFormDialog({ open, onOpenChange, initialData }: MoaFormDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[620px] max-h-[90vh] flex flex-col gap-0 p-0">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <Form {...form}>
            <form id="moa-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-0">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input {...field} placeholder="e.g. HTE-2024-001" className="pl-9 h-10 text-sm bg-gray-50 border-gray-200 focus:bg-white" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mb-4">
                    ...
                    <FormControl>
                      <Input {...field} placeholder="Official company name" className="h-10 text-sm bg-gray-50 border-gray-200 focus:bg-white" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea {...field} placeholder="Company address" rows={2} className="text-sm bg-gray-50 border-gray-200 focus:bg-white resize-none" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Full name" className="h-10 text-sm bg-gray-50 border-gray-200 focus:bg-white" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} type="email" placeholder="email@company.com" className="h-10 text-sm bg-gray-50 border-gray-200 focus:bg-white" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <SectionHeader icon={Calendar} label="Agreement Terms" />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} type="date" className="h-10 text-sm bg-gray-50 border-gray-200 focus:bg-white" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <SectionHeader icon={GraduationCap} label="Endorsement" />
        ...
        <DialogFooter className="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
          ...
          <Button
            type="submit"
            form="moa-form"
            className="h-10 px-6 text-sm font-semibold bg-primary hover:bg-primary/90 shadow-sm"
          >
